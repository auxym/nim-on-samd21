...
const DSU* = DSU_Type(
  ...
  ADDRx: DSU_ADDR_Type(loc: 0x41002004),
  ...
  ENDx: DSU_END_Type(loc: 0x41003008),
...
const NVMCTRL* = NVMCTRL_Type(
  ...
  ADDRx: NVMCTRL_ADDR_Type(loc: 0x4100401c),
...
const SERCOM0* = SERCOM0_Type(
  I2CM: SercomI2cm_Type(
    ...
    ADDRx: SercomI2cm_ADDR_Type(loc: 0x42000824),
  ...
  SPI: SercomSpi_Type(
    ...
    ADDRx: SercomSpi_ADDR_Type(loc: 0x42000824),
...
const SERCOM1* = SERCOM0_Type(
  I2CM: SercomI2cm_Type(
    ...
    ADDRx: SercomI2cm_ADDR_Type(loc: 0x42000c24),
  ...
  SPI: SercomSpi_Type(
    ...
    ADDRx: SercomSpi_ADDR_Type(loc: 0x42000c24),
...
const SERCOM2* = SERCOM0_Type(
  I2CM: SercomI2cm_Type(
    ...
    ADDRx: SercomI2cm_ADDR_Type(loc: 0x42001024),
  ...
  SPI: SercomSpi_Type(
    ...
    ADDRx: SercomSpi_ADDR_Type(loc: 0x42001024),
...
const SERCOM3* = SERCOM0_Type(
  I2CM: SercomI2cm_Type(
    ...
    ADDRx: SercomI2cm_ADDR_Type(loc: 0x42001424),
  ...
  SPI: SercomSpi_Type(
    ...
    ADDRx: SercomSpi_ADDR_Type(loc: 0x42001424),
...
const SERCOM4* = SERCOM0_Type(
  I2CM: SercomI2cm_Type(
    ...
    ADDRx: SercomI2cm_ADDR_Type(loc: 0x42001824),
  ...
  SPI: SercomSpi_Type(
    ...
    ADDRx: SercomSpi_ADDR_Type(loc: 0x42001824),
...
const SERCOM5* = SERCOM0_Type(
  I2CM: SercomI2cm_Type(
    ...
    ADDRx: SercomI2cm_ADDR_Type(loc: 0x42001c24),
  ...
  SPI: SercomSpi_Type(
    ...
    ADDRx: SercomSpi_ADDR_Type(loc: 0x42001c24),
...
func WSTATE0*(r: AC_STATUSA_Fields): AC_STATUSA_WSTATE0 {.inline.} =
  r.uint8.bitsliced(4 .. 5).AC_STATUSA_WSTATE0
...
func WSTATE0*(r: AC_STATUSC_Fields): AC_STATUSC_WSTATE0 {.inline.} =
  r.uint8.bitsliced(4 .. 5).AC_STATUSC_WSTATE0
...
func WINTSEL0*(r: AC_WINCTRL_Fields): AC_WINCTRL_WINTSEL0 {.inline.} =
  r.uint8.bitsliced(1 .. 2).AC_WINCTRL_WINTSEL0
...
func SPEED*(r: AC_COMPCTRL_Fields): AC_COMPCTRL_SPEED {.inline.} =
  r.uint32.bitsliced(2 .. 3).AC_COMPCTRL_SPEED
...
func INTSEL*(r: AC_COMPCTRL_Fields): AC_COMPCTRL_INTSEL {.inline.} =
  r.uint32.bitsliced(5 .. 6).AC_COMPCTRL_INTSEL
...
func MUXNEG*(r: AC_COMPCTRL_Fields): AC_COMPCTRL_MUXNEG {.inline.} =
  r.uint32.bitsliced(8 .. 10).AC_COMPCTRL_MUXNEG
...
func MUXPOS*(r: AC_COMPCTRL_Fields): AC_COMPCTRL_MUXPOS {.inline.} =
  r.uint32.bitsliced(12 .. 13).AC_COMPCTRL_MUXPOS
...
func OUTx*(r: AC_COMPCTRL_Fields): AC_COMPCTRL_OUT {.inline.} =
  r.uint32.bitsliced(16 .. 17).AC_COMPCTRL_OUT
...
func FLEN*(r: AC_COMPCTRL_Fields): AC_COMPCTRL_FLEN {.inline.} =
  r.uint32.bitsliced(24 .. 26).AC_COMPCTRL_FLEN
...
func REFSEL*(r: ADC_REFCTRL_Fields): ADC_REFCTRL_REFSEL {.inline.} =
  r.uint8.bitsliced(0 .. 3).ADC_REFCTRL_REFSEL
...
func SAMPLENUM*(r: ADC_AVGCTRL_Fields): ADC_AVGCTRL_SAMPLENUM {.inline.} =
  r.uint8.bitsliced(0 .. 3).ADC_AVGCTRL_SAMPLENUM
...
func RESSEL*(r: ADC_CTRLB_Fields): ADC_CTRLB_RESSEL {.inline.} =
  r.uint16.bitsliced(4 .. 5).ADC_CTRLB_RESSEL
...
func PRESCALER*(r: ADC_CTRLB_Fields): ADC_CTRLB_PRESCALER {.inline.} =
  r.uint16.bitsliced(8 .. 10).ADC_CTRLB_PRESCALER
...
func WINMODE*(r: ADC_WINCTRL_Fields): ADC_WINCTRL_WINMODE {.inline.} =
  r.uint8.bitsliced(0 .. 2).ADC_WINCTRL_WINMODE
...
func MUXPOS*(r: ADC_INPUTCTRL_Fields): ADC_INPUTCTRL_MUXPOS {.inline.} =
  r.uint32.bitsliced(0 .. 4).ADC_INPUTCTRL_MUXPOS
...
func MUXNEG*(r: ADC_INPUTCTRL_Fields): ADC_INPUTCTRL_MUXNEG {.inline.} =
  r.uint32.bitsliced(8 .. 12).ADC_INPUTCTRL_MUXNEG
...
func GAIN*(r: ADC_INPUTCTRL_Fields): ADC_INPUTCTRL_GAIN {.inline.} =
  r.uint32.bitsliced(24 .. 27).ADC_INPUTCTRL_GAIN
...
func REFSEL*(r: DAC_CTRLB_Fields): DAC_CTRLB_REFSEL {.inline.} =
  r.uint8.bitsliced(6 .. 7).DAC_CTRLB_REFSEL
...
func CRCBEATSIZE*(r: DMAC_CRCCTRL_Fields): DMAC_CRCCTRL_CRCBEATSIZE {.inline.} =
  r.uint16.bitsliced(0 .. 1).DMAC_CRCCTRL_CRCBEATSIZE
...
func CRCPOLY*(r: DMAC_CRCCTRL_Fields): DMAC_CRCCTRL_CRCPOLY {.inline.} =
  r.uint16.bitsliced(2 .. 3).DMAC_CRCCTRL_CRCPOLY
...
func CRCSRC*(r: DMAC_CRCCTRL_Fields): DMAC_CRCCTRL_CRCSRC {.inline.} =
  r.uint16.bitsliced(8 .. 13).DMAC_CRCCTRL_CRCSRC
...
func WRBQOS*(r: DMAC_QOSCTRL_Fields): DMAC_QOSCTRL_WRBQOS {.inline.} =
  r.uint8.bitsliced(0 .. 1).DMAC_QOSCTRL_WRBQOS
...
func FQOS*(r: DMAC_QOSCTRL_Fields): DMAC_QOSCTRL_FQOS {.inline.} =
  r.uint8.bitsliced(2 .. 3).DMAC_QOSCTRL_FQOS
...
func DQOS*(r: DMAC_QOSCTRL_Fields): DMAC_QOSCTRL_DQOS {.inline.} =
  r.uint8.bitsliced(4 .. 5).DMAC_QOSCTRL_DQOS
...
func EVACT*(r: DMAC_CHCTRLB_Fields): DMAC_CHCTRLB_EVACT {.inline.} =
  r.uint32.bitsliced(0 .. 2).DMAC_CHCTRLB_EVACT
...
func LVL*(r: DMAC_CHCTRLB_Fields): DMAC_CHCTRLB_LVL {.inline.} =
  r.uint32.bitsliced(5 .. 6).DMAC_CHCTRLB_LVL
...
func TRIGSRC*(r: DMAC_CHCTRLB_Fields): DMAC_CHCTRLB_TRIGSRC {.inline.} =
  r.uint32.bitsliced(8 .. 13).DMAC_CHCTRLB_TRIGSRC
...
func TRIGACT*(r: DMAC_CHCTRLB_Fields): DMAC_CHCTRLB_TRIGACT {.inline.} =
  r.uint32.bitsliced(22 .. 23).DMAC_CHCTRLB_TRIGACT
...
func CMD*(r: DMAC_CHCTRLB_Fields): DMAC_CHCTRLB_CMD {.inline.} =
  r.uint32.bitsliced(24 .. 25).DMAC_CHCTRLB_CMD
...
func NMISENSE*(r: EIC_NMICTRL_Fields): EIC_NMICTRL_NMISENSE {.inline.} =
  r.uint8.bitsliced(0 .. 2).EIC_NMICTRL_NMISENSE
...
func SENSE0*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE0 {.inline.} =
  r.uint32.bitsliced(0 .. 2).EIC_CONFIG_SENSE0
...
func SENSE1*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE1 {.inline.} =
  r.uint32.bitsliced(4 .. 6).EIC_CONFIG_SENSE1
...
func SENSE2*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE2 {.inline.} =
  r.uint32.bitsliced(8 .. 10).EIC_CONFIG_SENSE2
...
func SENSE3*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE3 {.inline.} =
  r.uint32.bitsliced(12 .. 14).EIC_CONFIG_SENSE3
...
func SENSE4*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE4 {.inline.} =
  r.uint32.bitsliced(16 .. 18).EIC_CONFIG_SENSE4
...
func SENSE5*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE5 {.inline.} =
  r.uint32.bitsliced(20 .. 22).EIC_CONFIG_SENSE5
...
func SENSE6*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE6 {.inline.} =
  r.uint32.bitsliced(24 .. 26).EIC_CONFIG_SENSE6
...
func SENSE7*(r: EIC_CONFIG_Fields): EIC_CONFIG_SENSE7 {.inline.} =
  r.uint32.bitsliced(28 .. 30).EIC_CONFIG_SENSE7
...
func PATH*(r: EVSYS_CHANNEL_Fields): EVSYS_CHANNEL_PATH {.inline.} =
  r.uint32.bitsliced(24 .. 25).EVSYS_CHANNEL_PATH
...
func EDGSEL*(r: EVSYS_CHANNEL_Fields): EVSYS_CHANNEL_EDGSEL {.inline.} =
  r.uint32.bitsliced(26 .. 27).EVSYS_CHANNEL_EDGSEL
...
func CHANNEL*(r: EVSYS_USER_Fields): EVSYS_USER_CHANNEL {.inline.} =
  r.uint16.bitsliced(8 .. 12).EVSYS_USER_CHANNEL
...
func ID*(r: GCLK_CLKCTRL_Fields): GCLK_CLKCTRL_ID {.inline.} =
  r.uint16.bitsliced(0 .. 5).GCLK_CLKCTRL_ID
...
func GEN*(r: GCLK_CLKCTRL_Fields): GCLK_CLKCTRL_GEN {.inline.} =
  r.uint16.bitsliced(8 .. 11).GCLK_CLKCTRL_GEN
...
func SRC*(r: GCLK_GENCTRL_Fields): GCLK_GENCTRL_SRC {.inline.} =
  r.uint32.bitsliced(8 .. 12).GCLK_GENCTRL_SRC
...
func SLOTSIZE*(r: I2S_CLKCTRL_Fields): I2S_CLKCTRL_SLOTSIZE {.inline.} =
  r.uint32.bitsliced(0 .. 1).I2S_CLKCTRL_SLOTSIZE
...
func FSWIDTH*(r: I2S_CLKCTRL_Fields): I2S_CLKCTRL_FSWIDTH {.inline.} =
  r.uint32.bitsliced(5 .. 6).I2S_CLKCTRL_FSWIDTH
...
func BITDELAY*(r: I2S_CLKCTRL_Fields): I2S_CLKCTRL_BITDELAY {.inline.} =
  r.uint32.bitsliced(7 .. 7).I2S_CLKCTRL_BITDELAY
...
func FSSEL*(r: I2S_CLKCTRL_Fields): I2S_CLKCTRL_FSSEL {.inline.} =
  r.uint32.bitsliced(8 .. 8).I2S_CLKCTRL_FSSEL
...
func SCKSEL*(r: I2S_CLKCTRL_Fields): I2S_CLKCTRL_SCKSEL {.inline.} =
  r.uint32.bitsliced(12 .. 12).I2S_CLKCTRL_SCKSEL
...
func MCKSEL*(r: I2S_CLKCTRL_Fields): I2S_CLKCTRL_MCKSEL {.inline.} =
  r.uint32.bitsliced(16 .. 16).I2S_CLKCTRL_MCKSEL
...
func SERMODE*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_SERMODE {.inline.} =
  r.uint32.bitsliced(0 .. 1).I2S_SERCTRL_SERMODE
...
func TXDEFAULT*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_TXDEFAULT {.inline.} =
  r.uint32.bitsliced(2 .. 3).I2S_SERCTRL_TXDEFAULT
...
func TXSAME*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_TXSAME {.inline.} =
  r.uint32.bitsliced(4 .. 4).I2S_SERCTRL_TXSAME
...
func CLKSEL*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_CLKSEL {.inline.} =
  r.uint32.bitsliced(5 .. 5).I2S_SERCTRL_CLKSEL
...
func SLOTADJ*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_SLOTADJ {.inline.} =
  r.uint32.bitsliced(7 .. 7).I2S_SERCTRL_SLOTADJ
...
func DATASIZE*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_DATASIZE {.inline.} =
  r.uint32.bitsliced(8 .. 10).I2S_SERCTRL_DATASIZE
...
func WORDADJ*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_WORDADJ {.inline.} =
  r.uint32.bitsliced(12 .. 12).I2S_SERCTRL_WORDADJ
...
func EXTEND*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_EXTEND {.inline.} =
  r.uint32.bitsliced(13 .. 14).I2S_SERCTRL_EXTEND
...
func BITREV*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_BITREV {.inline.} =
  r.uint32.bitsliced(15 .. 15).I2S_SERCTRL_BITREV
...
func MONO*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_MONO {.inline.} =
  r.uint32.bitsliced(24 .. 24).I2S_SERCTRL_MONO
...
func DMA*(r: I2S_SERCTRL_Fields): I2S_SERCTRL_DMA {.inline.} =
  r.uint32.bitsliced(25 .. 25).I2S_SERCTRL_DMA
...
func CMD*(r: NVMCTRL_CTRLA_Fields): NVMCTRL_CTRLA_CMD {.inline.} =
  r.uint16.bitsliced(0 .. 6).NVMCTRL_CTRLA_CMD
...
func CMDEX*(r: NVMCTRL_CTRLA_Fields): NVMCTRL_CTRLA_CMDEX {.inline.} =
  r.uint16.bitsliced(8 .. 15).NVMCTRL_CTRLA_CMDEX
...
func RWS*(r: NVMCTRL_CTRLB_Fields): NVMCTRL_CTRLB_RWS {.inline.} =
  r.uint32.bitsliced(1 .. 4).NVMCTRL_CTRLB_RWS
...
func SLEEPPRM*(r: NVMCTRL_CTRLB_Fields): NVMCTRL_CTRLB_SLEEPPRM {.inline.} =
  r.uint32.bitsliced(8 .. 9).NVMCTRL_CTRLB_SLEEPPRM
...
func READMODE*(r: NVMCTRL_CTRLB_Fields): NVMCTRL_CTRLB_READMODE {.inline.} =
  r.uint32.bitsliced(16 .. 17).NVMCTRL_CTRLB_READMODE
...
func PSZ*(r: NVMCTRL_PARAM_Fields): NVMCTRL_PARAM_PSZ {.inline.} =
  r.uint32.bitsliced(16 .. 18).NVMCTRL_PARAM_PSZ
...
func IDLE*(r: PM_SLEEP_Fields): PM_SLEEP_IDLE {.inline.} =
  r.uint8.bitsliced(0 .. 1).PM_SLEEP_IDLE
...
func CPUDIV*(r: PM_CPUSEL_Fields): PM_CPUSEL_CPUDIV {.inline.} =
  r.uint8.bitsliced(0 .. 2).PM_CPUSEL_CPUDIV
...
func APBADIV*(r: PM_APBASEL_Fields): PM_APBASEL_APBADIV {.inline.} =
  r.uint8.bitsliced(0 .. 2).PM_APBASEL_APBADIV
...
func APBBDIV*(r: PM_APBBSEL_Fields): PM_APBBSEL_APBBDIV {.inline.} =
  r.uint8.bitsliced(0 .. 2).PM_APBBSEL_APBBDIV
...
func APBCDIV*(r: PM_APBCSEL_Fields): PM_APBCSEL_APBCDIV {.inline.} =
  r.uint8.bitsliced(0 .. 2).PM_APBCSEL_APBCDIV
...
func PMUXE*(r: PORT_PMUX0_Fields): PORT_PMUX0_PMUXE {.inline.} =
  r.uint8.bitsliced(0 .. 3).PORT_PMUX0_PMUXE
...
func PMUXO*(r: PORT_PMUX0_Fields): PORT_PMUX0_PMUXO {.inline.} =
  r.uint8.bitsliced(4 .. 7).PORT_PMUX0_PMUXO
...
func MODE*(r: RtcMode0_CTRL_Fields): RtcMode0_CTRL_MODE {.inline.} =
  r.uint16.bitsliced(2 .. 3).RtcMode0_CTRL_MODE
...
func PRESCALER*(r: RtcMode0_CTRL_Fields): RtcMode0_CTRL_PRESCALER {.inline.} =
  r.uint16.bitsliced(8 .. 11).RtcMode0_CTRL_PRESCALER
...
func MODE*(r: RtcMode1_CTRL_Fields): RtcMode1_CTRL_MODE {.inline.} =
  r.uint16.bitsliced(2 .. 3).RtcMode1_CTRL_MODE
...
func PRESCALER*(r: RtcMode1_CTRL_Fields): RtcMode1_CTRL_PRESCALER {.inline.} =
  r.uint16.bitsliced(8 .. 11).RtcMode1_CTRL_PRESCALER
...
func MODE*(r: RtcMode2_CTRL_Fields): RtcMode2_CTRL_MODE {.inline.} =
  r.uint16.bitsliced(2 .. 3).RtcMode2_CTRL_MODE
...
func PRESCALER*(r: RtcMode2_CTRL_Fields): RtcMode2_CTRL_PRESCALER {.inline.} =
  r.uint16.bitsliced(8 .. 11).RtcMode2_CTRL_PRESCALER
...
func HOUR*(r: RtcMode2_CLOCK_Fields): RtcMode2_CLOCK_HOUR {.inline.} =
  r.uint32.bitsliced(12 .. 16).RtcMode2_CLOCK_HOUR
...
func HOUR*(r: RtcMode2_ALARM_Fields): RtcMode2_ALARM_HOUR {.inline.} =
  r.uint32.bitsliced(12 .. 16).RtcMode2_ALARM_HOUR
...
func SEL*(r: RtcMode2_MASK_Fields): RtcMode2_MASK_SEL {.inline.} =
  r.uint8.bitsliced(0 .. 2).RtcMode2_MASK_SEL
...
func MODE*(r: SercomI2cm_CTRLA_Fields): SercomI2cm_CTRLA_MODE {.inline.} =
  r.uint32.bitsliced(2 .. 4).SercomI2cm_CTRLA_MODE
...
func MODE*(r: SercomI2cs_CTRLA_Fields): SercomI2cs_CTRLA_MODE {.inline.} =
  r.uint32.bitsliced(2 .. 4).SercomI2cs_CTRLA_MODE
...
func MODE*(r: SercomSpi_CTRLA_Fields): SercomSpi_CTRLA_MODE {.inline.} =
  r.uint32.bitsliced(2 .. 4).SercomSpi_CTRLA_MODE
...
func MODE*(r: SercomUsart_CTRLA_Fields): SercomUsart_CTRLA_MODE {.inline.} =
  r.uint32.bitsliced(2 .. 4).SercomUsart_CTRLA_MODE
...
func GAIN*(r: SYSCTRL_XOSC_Fields): SYSCTRL_XOSC_GAIN {.inline.} =
  r.uint16.bitsliced(8 .. 10).SYSCTRL_XOSC_GAIN
...
func PRESC*(r: SYSCTRL_OSC8M_Fields): SYSCTRL_OSC8M_PRESC {.inline.} =
  r.uint32.bitsliced(8 .. 9).SYSCTRL_OSC8M_PRESC
...
func FRANGE*(r: SYSCTRL_OSC8M_Fields): SYSCTRL_OSC8M_FRANGE {.inline.} =
  r.uint32.bitsliced(30 .. 31).SYSCTRL_OSC8M_FRANGE
...
func ACTION*(r: SYSCTRL_BOD33_Fields): SYSCTRL_BOD33_ACTION {.inline.} =
  r.uint32.bitsliced(3 .. 4).SYSCTRL_BOD33_ACTION
...
func PSEL*(r: SYSCTRL_BOD33_Fields): SYSCTRL_BOD33_PSEL {.inline.} =
  r.uint32.bitsliced(12 .. 15).SYSCTRL_BOD33_PSEL
...
func FILTER*(r: SYSCTRL_DPLLCTRLB_Fields): SYSCTRL_DPLLCTRLB_FILTER {.inline.} =
  r.uint32.bitsliced(0 .. 1).SYSCTRL_DPLLCTRLB_FILTER
...
func REFCLK*(r: SYSCTRL_DPLLCTRLB_Fields): SYSCTRL_DPLLCTRLB_REFCLK {.inline.} =
  r.uint32.bitsliced(4 .. 5).SYSCTRL_DPLLCTRLB_REFCLK
...
func LTIME*(r: SYSCTRL_DPLLCTRLB_Fields): SYSCTRL_DPLLCTRLB_LTIME {.inline.} =
  r.uint32.bitsliced(8 .. 10).SYSCTRL_DPLLCTRLB_LTIME
...
func MODE*(r: TcCount8_CTRLA_Fields): TcCount8_CTRLA_MODE {.inline.} =
  r.uint16.bitsliced(2 .. 3).TcCount8_CTRLA_MODE
...
func WAVEGEN*(r: TcCount8_CTRLA_Fields): TcCount8_CTRLA_WAVEGEN {.inline.} =
  r.uint16.bitsliced(5 .. 6).TcCount8_CTRLA_WAVEGEN
...
func PRESCALER*(r: TcCount8_CTRLA_Fields): TcCount8_CTRLA_PRESCALER {.inline.} =
  r.uint16.bitsliced(8 .. 10).TcCount8_CTRLA_PRESCALER
...
func PRESCSYNC*(r: TcCount8_CTRLA_Fields): TcCount8_CTRLA_PRESCSYNC {.inline.} =
  r.uint16.bitsliced(12 .. 13).TcCount8_CTRLA_PRESCSYNC
...
func CMD*(r: TcCount8_CTRLBCLR_Fields): TcCount8_CTRLBCLR_CMD {.inline.} =
  r.uint8.bitsliced(6 .. 7).TcCount8_CTRLBCLR_CMD
...
func CMD*(r: TcCount8_CTRLBSET_Fields): TcCount8_CTRLBSET_CMD {.inline.} =
  r.uint8.bitsliced(6 .. 7).TcCount8_CTRLBSET_CMD
...
func EVACT*(r: TcCount8_EVCTRL_Fields): TcCount8_EVCTRL_EVACT {.inline.} =
  r.uint16.bitsliced(0 .. 2).TcCount8_EVCTRL_EVACT
...
func MODE*(r: TcCount16_CTRLA_Fields): TcCount16_CTRLA_MODE {.inline.} =
  r.uint16.bitsliced(2 .. 3).TcCount16_CTRLA_MODE
...
func WAVEGEN*(r: TcCount16_CTRLA_Fields): TcCount16_CTRLA_WAVEGEN {.inline.} =
  r.uint16.bitsliced(5 .. 6).TcCount16_CTRLA_WAVEGEN
...
func PRESCALER*(r: TcCount16_CTRLA_Fields): TcCount16_CTRLA_PRESCALER {.inline.} =
  r.uint16.bitsliced(8 .. 10).TcCount16_CTRLA_PRESCALER
...
func PRESCSYNC*(r: TcCount16_CTRLA_Fields): TcCount16_CTRLA_PRESCSYNC {.inline.} =
  r.uint16.bitsliced(12 .. 13).TcCount16_CTRLA_PRESCSYNC
...
func CMD*(r: TcCount16_CTRLBCLR_Fields): TcCount16_CTRLBCLR_CMD {.inline.} =
  r.uint8.bitsliced(6 .. 7).TcCount16_CTRLBCLR_CMD
...
func CMD*(r: TcCount16_CTRLBSET_Fields): TcCount16_CTRLBSET_CMD {.inline.} =
  r.uint8.bitsliced(6 .. 7).TcCount16_CTRLBSET_CMD
...
func EVACT*(r: TcCount16_EVCTRL_Fields): TcCount16_EVCTRL_EVACT {.inline.} =
  r.uint16.bitsliced(0 .. 2).TcCount16_EVCTRL_EVACT
...
func MODE*(r: TcCount32_CTRLA_Fields): TcCount32_CTRLA_MODE {.inline.} =
  r.uint16.bitsliced(2 .. 3).TcCount32_CTRLA_MODE
...
func WAVEGEN*(r: TcCount32_CTRLA_Fields): TcCount32_CTRLA_WAVEGEN {.inline.} =
  r.uint16.bitsliced(5 .. 6).TcCount32_CTRLA_WAVEGEN
...
func PRESCALER*(r: TcCount32_CTRLA_Fields): TcCount32_CTRLA_PRESCALER {.inline.} =
  r.uint16.bitsliced(8 .. 10).TcCount32_CTRLA_PRESCALER
...
func PRESCSYNC*(r: TcCount32_CTRLA_Fields): TcCount32_CTRLA_PRESCSYNC {.inline.} =
  r.uint16.bitsliced(12 .. 13).TcCount32_CTRLA_PRESCSYNC
...
func CMD*(r: TcCount32_CTRLBCLR_Fields): TcCount32_CTRLBCLR_CMD {.inline.} =
  r.uint8.bitsliced(6 .. 7).TcCount32_CTRLBCLR_CMD
...
func CMD*(r: TcCount32_CTRLBSET_Fields): TcCount32_CTRLBSET_CMD {.inline.} =
  r.uint8.bitsliced(6 .. 7).TcCount32_CTRLBSET_CMD
...
func EVACT*(r: TcCount32_EVCTRL_Fields): TcCount32_EVCTRL_EVACT {.inline.} =
  r.uint16.bitsliced(0 .. 2).TcCount32_EVCTRL_EVACT
...
func RESOLUTION*(r: TCC0_CTRLA_Fields): TCC0_CTRLA_RESOLUTION {.inline.} =
  r.uint32.bitsliced(5 .. 6).TCC0_CTRLA_RESOLUTION
...
func PRESCALER*(r: TCC0_CTRLA_Fields): TCC0_CTRLA_PRESCALER {.inline.} =
  r.uint32.bitsliced(8 .. 10).TCC0_CTRLA_PRESCALER
...
func PRESCSYNC*(r: TCC0_CTRLA_Fields): TCC0_CTRLA_PRESCSYNC {.inline.} =
  r.uint32.bitsliced(12 .. 13).TCC0_CTRLA_PRESCSYNC
...
func IDXCMD*(r: TCC0_CTRLBCLR_Fields): TCC0_CTRLBCLR_IDXCMD {.inline.} =
  r.uint8.bitsliced(3 .. 4).TCC0_CTRLBCLR_IDXCMD
...
func CMD*(r: TCC0_CTRLBCLR_Fields): TCC0_CTRLBCLR_CMD {.inline.} =
  r.uint8.bitsliced(5 .. 7).TCC0_CTRLBCLR_CMD
...
func IDXCMD*(r: TCC0_CTRLBSET_Fields): TCC0_CTRLBSET_IDXCMD {.inline.} =
  r.uint8.bitsliced(3 .. 4).TCC0_CTRLBSET_IDXCMD
...
func CMD*(r: TCC0_CTRLBSET_Fields): TCC0_CTRLBSET_CMD {.inline.} =
  r.uint8.bitsliced(5 .. 7).TCC0_CTRLBSET_CMD
...
func SRC*(r: TCC0_FCTRLA_Fields): TCC0_FCTRLA_SRC {.inline.} =
  r.uint32.bitsliced(0 .. 1).TCC0_FCTRLA_SRC
...
func BLANK*(r: TCC0_FCTRLA_Fields): TCC0_FCTRLA_BLANK {.inline.} =
  r.uint32.bitsliced(5 .. 6).TCC0_FCTRLA_BLANK
...
func HALT*(r: TCC0_FCTRLA_Fields): TCC0_FCTRLA_HALT {.inline.} =
  r.uint32.bitsliced(8 .. 9).TCC0_FCTRLA_HALT
...
func CHSEL*(r: TCC0_FCTRLA_Fields): TCC0_FCTRLA_CHSEL {.inline.} =
  r.uint32.bitsliced(10 .. 11).TCC0_FCTRLA_CHSEL
...
func CAPTURE*(r: TCC0_FCTRLA_Fields): TCC0_FCTRLA_CAPTURE {.inline.} =
  r.uint32.bitsliced(12 .. 14).TCC0_FCTRLA_CAPTURE
...
func SRC*(r: TCC0_FCTRLB_Fields): TCC0_FCTRLB_SRC {.inline.} =
  r.uint32.bitsliced(0 .. 1).TCC0_FCTRLB_SRC
...
func BLANK*(r: TCC0_FCTRLB_Fields): TCC0_FCTRLB_BLANK {.inline.} =
  r.uint32.bitsliced(5 .. 6).TCC0_FCTRLB_BLANK
...
func HALT*(r: TCC0_FCTRLB_Fields): TCC0_FCTRLB_HALT {.inline.} =
  r.uint32.bitsliced(8 .. 9).TCC0_FCTRLB_HALT
...
func CHSEL*(r: TCC0_FCTRLB_Fields): TCC0_FCTRLB_CHSEL {.inline.} =
  r.uint32.bitsliced(10 .. 11).TCC0_FCTRLB_CHSEL
...
func CAPTURE*(r: TCC0_FCTRLB_Fields): TCC0_FCTRLB_CAPTURE {.inline.} =
  r.uint32.bitsliced(12 .. 14).TCC0_FCTRLB_CAPTURE
...
func EVACT0*(r: TCC0_EVCTRL_Fields): TCC0_EVCTRL_EVACT0 {.inline.} =
  r.uint32.bitsliced(0 .. 2).TCC0_EVCTRL_EVACT0
...
func EVACT1*(r: TCC0_EVCTRL_Fields): TCC0_EVCTRL_EVACT1 {.inline.} =
  r.uint32.bitsliced(3 .. 5).TCC0_EVCTRL_EVACT1
...
func CNTSEL*(r: TCC0_EVCTRL_Fields): TCC0_EVCTRL_CNTSEL {.inline.} =
  r.uint32.bitsliced(6 .. 7).TCC0_EVCTRL_CNTSEL
...
func WAVEGEN*(r: TCC0_WAVE_Fields): TCC0_WAVE_WAVEGEN {.inline.} =
  r.uint32.bitsliced(0 .. 2).TCC0_WAVE_WAVEGEN
...
func RAMP*(r: TCC0_WAVE_Fields): TCC0_WAVE_RAMP {.inline.} =
  r.uint32.bitsliced(4 .. 5).TCC0_WAVE_RAMP
...
func WAVEGENB*(r: TCC0_WAVEB_Fields): TCC0_WAVEB_WAVEGENB {.inline.} =
  r.uint32.bitsliced(0 .. 2).TCC0_WAVEB_WAVEGENB
...
func RAMPB*(r: TCC0_WAVEB_Fields): TCC0_WAVEB_RAMPB {.inline.} =
  r.uint32.bitsliced(4 .. 5).TCC0_WAVEB_RAMPB
...
func MODE*(r: UsbDevice_CTRLA_Fields): UsbDevice_CTRLA_MODE {.inline.} =
  r.uint8.bitsliced(7 .. 7).UsbDevice_CTRLA_MODE
...
func CQOS*(r: UsbDevice_QOSCTRL_Fields): UsbDevice_QOSCTRL_CQOS {.inline.} =
  r.uint8.bitsliced(0 .. 1).UsbDevice_QOSCTRL_CQOS
...
func DQOS*(r: UsbDevice_QOSCTRL_Fields): UsbDevice_QOSCTRL_DQOS {.inline.} =
  r.uint8.bitsliced(2 .. 3).UsbDevice_QOSCTRL_DQOS
...
func SPDCONF*(r: UsbDevice_CTRLB_Fields): UsbDevice_CTRLB_SPDCONF {.inline.} =
  r.uint16.bitsliced(2 .. 3).UsbDevice_CTRLB_SPDCONF
...
func LPMHDSK*(r: UsbDevice_CTRLB_Fields): UsbDevice_CTRLB_LPMHDSK {.inline.} =
  r.uint16.bitsliced(10 .. 11).UsbDevice_CTRLB_LPMHDSK
...
func SPEED*(r: UsbDevice_STATUS_Fields): UsbDevice_STATUS_SPEED {.inline.} =
  r.uint8.bitsliced(2 .. 3).UsbDevice_STATUS_SPEED

func LINESTATE*(r: UsbDevice_STATUS_Fields): UsbDevice_STATUS_LINESTATE {.inline.} =
  r.uint8.bitsliced(6 .. 7).UsbDevice_STATUS_LINESTATE

func FSMSTATE*(r: UsbDevice_FSMSTATUS_Fields): UsbDevice_FSMSTATUS_FSMSTATE {.inline.} =
  r.uint8.bitsliced(0 .. 6).UsbDevice_FSMSTATUS_FSMSTATE
...
func MODE*(r: UsbHost_CTRLA_Fields): UsbHost_CTRLA_MODE {.inline.} =
  r.uint8.bitsliced(7 .. 7).UsbHost_CTRLA_MODE
...
func CQOS*(r: UsbHost_QOSCTRL_Fields): UsbHost_QOSCTRL_CQOS {.inline.} =
  r.uint8.bitsliced(0 .. 1).UsbHost_QOSCTRL_CQOS
...
func DQOS*(r: UsbHost_QOSCTRL_Fields): UsbHost_QOSCTRL_DQOS {.inline.} =
  r.uint8.bitsliced(2 .. 3).UsbHost_QOSCTRL_DQOS
...
func SPDCONF*(r: UsbHost_CTRLB_Fields): UsbHost_CTRLB_SPDCONF {.inline.} =
  r.uint16.bitsliced(2 .. 3).UsbHost_CTRLB_SPDCONF
...
func FSMSTATE*(r: UsbHost_FSMSTATUS_Fields): UsbHost_FSMSTATUS_FSMSTATE {.inline.} =
  r.uint8.bitsliced(0 .. 6).UsbHost_FSMSTATUS_FSMSTATE
...
func PER*(r: WDT_CONFIG_Fields): WDT_CONFIG_PER {.inline.} =
  r.uint8.bitsliced(0 .. 3).WDT_CONFIG_PER
...
func WINDOW*(r: WDT_CONFIG_Fields): WDT_CONFIG_WINDOW {.inline.} =
  r.uint8.bitsliced(4 .. 7).WDT_CONFIG_WINDOW
...
func EWOFFSET*(r: WDT_EWCTRL_Fields): WDT_EWCTRL_EWOFFSET {.inline.} =
  r.uint8.bitsliced(0 .. 3).WDT_EWCTRL_EWOFFSET
